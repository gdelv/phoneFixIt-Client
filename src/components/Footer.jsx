    ...
    return (
        <footer class="footer is-flex">
            ...
            <div class="column">
                ...
                <h6 class="subtitle is-6 is-size-7-mobile is-spaced">94 South Broadway Hicksville NY, 11801 USA</h6>
                <h6 class="subtitle is-6 is-size-7-mobile is-spaced">208 Glen St. Glen Cove, NY, 11542 USA</h6>
            </div>
            <div class="column">
                <h4 class="title is-4 is-size-7-mobile ">Contact</h4>
                <h6 class="subtitle is-6 is-size-7-mobile is-spaced">Hicksville, NY (516)-513-0800</h6>
                <h6 class="subtitle is-6 is-size-7-mobile is-spaced">Glen Cove, NY (516)-801-6320</h6>
            </div>
            <div class="column">
