        ...
        <section className="hero is-large has-bg-img">
            <div className="hero-body">
                <div className="container has-text-centered">
                    <h1 className="title is-1 has-text-white has-text-weight-bold	">Welcome to PHONEFIXIT</h1>
                    <h2 className="subtitle is-3 has-text-black">We fix your devices at our stores, your place or by mail.</h2>
